...
# the best xval results in the format [k-mers,PseAAC,c-value,t-value]
...
def get_args():
    ...
    parser.add_argument("-k", "--kmer", type=int, nargs="?",
                        ...
                        help="""The kmer size needed for feature generation
                        (default=4).""")
    parser.add_argument("-p", "--pseaac", nargs="?", type=int,
                        dest="pseaac", required=False, const=3, default=None,
                        help="""Expand feature set to include pseudo amino acid
                        composition. Specify lamba (default=3).
                        Weight = 0.05.""")
    parser.add_argument("-y", "--physico", action="store_true",
                        dest="physico", required=False,
                        help="""Expand feature set to include physicochemical
                        composition.""")
    ...
    parser.add_argument("-O", "--optimal", action="store_true",
                        ...
                        help="""Pick the optimal parameters for the GTA gene
                        homolog classification""")
    parser.add_argument("-f", "--folder",type=str, nargs=1,
                        dest="folder", required=False,
                        help="""Feed GTA_Hunter a folder from which to run the
                        program on all""")
